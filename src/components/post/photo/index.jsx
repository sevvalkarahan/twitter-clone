export default function Photo({ photos }) {
    switch (photos.length) {
        case 1:
            return (
                <div className="mt-3">
                    <img src={photos[0]} alt="" className="border max-h-[510px] object-cover border-[#212327] rounded-2xl" />
                </div>
            )

        case 2:
            return (
                <div className="mt-3 grid grid-cols-2 gap-0.5 h-[288px] border border-[#212327] rounded-2xl overflow-hidden">
        ...
        case 4:
            return (
                <div className="mt-3 grid grid-cols-2 gap-0.5 h-[286px] border border-[#212327] rounded-2xl overflow-hidden">
