...
export default function Topic({ item }) {
    return (
        <Link
            to="/"
            className="py-3 px-4 transition-colors hover:bg-white/[0.04] relative"
        >
            ...
            <Popover className="absolute top-1.5 right-2">
                <Popover.Button
                    className="outline-none w-[34.75px] h-[34.75px] rounded-full text-[#71767b] flex items-center justify-center hover:text-[#1d9bf0] transition-colors relative before:absolute before:inset-0 before:rounded-full hover:before:hover:bg-[#1d9b f01a] before:transition-all before:z-[-1] before:opacity-[.15] z-[1]"
                >
                ...
                <Popover.Panel className="w-[24rem] rounded-xl grid absolute top-2 overflow-hidden right-0 bg-black shadow-box z-[2]">
                    <button type="button" className="hover:bg-white/[0.5] transition-colors text-left py-3 px-4 flex items-center gap-3 leading-5 font-bold ">
                        <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                            <path
                                fill="currentColor"
